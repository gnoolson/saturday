...
@Log4j2
@Component
public class ErrorScriptLauncher extends CommonScriptLauncher implements ScriptErrorHandler.ScriptLauncher {


    public ErrorScriptLauncher(ScriptErrorHandler scriptErrorHandler,
    ...
    @Override
    public void execute(ScriptId scriptId, Map<String, Object> argsData) {
