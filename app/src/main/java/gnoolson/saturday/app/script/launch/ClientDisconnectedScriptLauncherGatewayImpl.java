...
@Log4j2
@Component
public class ClientDisconnectedScriptLauncherGatewayImpl extends CommonScriptLauncher implements ClientDisconnectedScriptLauncherGateway {
     ...
     *
     * */
    public ClientDisconnectedScriptLauncherGatewayImpl(ScriptErrorHandler scriptErrorHandler,
    ...
    @Override
    public void execute(ScriptId scriptId, ClientId clientId) {
        try (Locker.LockHandle ignore = locker.lockIds(LockId.of(scriptId))) {
            ...
            argsData.put(DefaultField.SOURCE, "CLIENT_DISCONNECTED");
            argsData.put("clientId", clientId);
