...
@Log4j2
@Component
public class ClientConnectedScriptLauncherGatewayImpl extends CommonScriptLauncher implements ClientConnectedScriptLauncherGateway {
     ...
     *
     * */
    public ClientConnectedScriptLauncherGatewayImpl(ScriptErrorHandler scriptErrorHandler,
    ...
    public void execute(ScriptId scriptId, ClientId clientId) {
        try (Locker.LockHandle ignore = locker.lockIds(LockId.of(scriptId))) {
            ...
            argsData.put(DefaultField.SOURCE, "CLIENT_CONNECTED");
