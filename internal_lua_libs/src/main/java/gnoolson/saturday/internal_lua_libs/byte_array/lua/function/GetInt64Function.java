...
public class GetInt64Function extends TwoArgFunction {
    ...
    public LuaValue call(LuaValue selfLuaValue, LuaValue positionLuaValue) {
        ...
        long l = ByteBuffer.wrap(byteArrayLuaTable.getBytes()).order(byteOrder).getLong(position);
        return LuaString.valueOf(l);
    }
