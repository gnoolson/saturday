...
public class GetFloatFunction extends TwoArgFunction {
    ...
    public LuaValue call(LuaValue selfLuaValue, LuaValue positionLuaValue) {
        ...
        float f = ByteBuffer.wrap(byteArrayLuaTable.getBytes()).order(byteOrder).getFloat(position);
        return LuaString.valueOf(f);
    }
