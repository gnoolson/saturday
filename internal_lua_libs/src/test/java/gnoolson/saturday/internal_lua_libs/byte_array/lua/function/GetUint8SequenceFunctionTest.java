...
class GetUint8SequenceFunctionTest {

    @Test
    public void general() {
        GetUint8SequenceFunction function = new GetUint8SequenceFunction();

        byte[] data = {0x09, 0x05, 0x03, 0x10, 0x20, 0x30};

        LuaValue result = function.call(new ByteArrayLuaTable(data), LuaValue.valueOf(0));
    ...
    public void position() {
        ...
        LuaValue result = function.call(new ByteArrayLuaTable(data), LuaValue.valueOf(2));
