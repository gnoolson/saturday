...
class MarkDisconnectedTest extends GeneralTest {
    ...
    void general(){
        ...
        MarkDisconnected markDisconnected = new MarkDisconnected(
        ...
        markDisconnected.exec(client1P1.getId());

        Assertions.assertEquals(TimeInMs.of(999), client1P1.getDisconnectedAt());
